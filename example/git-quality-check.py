...
if __name__ == "__main__":
    ...
    print("    A high number of bad commits means you should avoid WIP or empty commits for example.")
    print("Percent of test commits: ", format_number(test_index))
    print("    A low number of test commits, might indicates that you are not writing enough tests for your software.")
    print("Percent of old branches: ", format_number(old_branches_index))
    print("    A high percent of old branches, means that you should delete unused branches or already merged branches in your repo.")
    print("Percent of coupled branches", format_number(coupling_index))
    print("    A high percent of coupled branches, means that you should use more often squash \
